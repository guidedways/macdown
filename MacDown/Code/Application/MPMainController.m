                 ...
                 withReplyEvent:(NSAppleEventDescriptor *)reply
{
    ...
    [c openDocumentWithContentsOfURL:target display:YES completionHandler:
     ^(NSDocument *document, BOOL wasOpen, NSError *error) {
         ...
         MPEditorView *textView = [(MPDocument *)document valueForKey:@"editor"];
         [textView setInsertionPointLineNumber:@(lineNumber)];
         [textView setInsertionPointColumnNumber:@(columnNumber)];
